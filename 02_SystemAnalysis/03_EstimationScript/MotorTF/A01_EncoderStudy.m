...
maxSpeeds_xMs = zeros(1,7);
times_xs = [en_2ms.Time(2) en_4ms.Time(2) en_6ms.Time(2) en_8ms.Time(2) en_10ms.Time(2) en_12ms.Time(2) en_14ms.Time(2)];


maxSpeeds_xMs(1) = mean(en_2ms.mVel(159:553))/ en_2ms.Time(2)*step2rad;
maxSpeeds_xMs(2) = mean(en_4ms.mVel(49:288))/ en_4ms.Time(2)*step2rad;
maxSpeeds_xMs(3) = mean(en_6ms.mVel(38:197))/ en_6ms.Time(2)*step2rad;
maxSpeeds_xMs(4) = mean(en_8ms.mVel(30:152))/ en_8ms.Time(2)*step2rad;
maxSpeeds_xMs(5) = mean(en_10ms.mVel(31:114))/ en_10ms.Time(2)*step2rad;
maxSpeeds_xMs(6) = mean(en_12ms.mVel(27:115))/ en_12ms.Time(2)*step2rad;
maxSpeeds_xMs(7) = mean(en_14ms.mVel(22:107))/ en_14ms.Time(2)*step2rad;
